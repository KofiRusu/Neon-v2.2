export const agentKnowledgebase = {
  brandVoice:
    "Personal and consultative - like advice from a trusted neon artisan and friend",
  ...
  emailStrategy: {
    segmentation: {
      ...
      activeCustomers: {
        messaging:
          "Project updates, exclusive previews, maintenance tips, upgrade opportunities",
      ...
      homeowners: {
        messaging:
          "Design inspiration, home décor trends, seasonal ideas, personal stories",
  ...
  products: [
    ...
    },
    {
      ...
      emailMessaging: {
        subject:
          "The secret to Instagram-worthy events (it's not what you think)",
  ...
  contentTypes: {
    ...
    retention: {
      structure:
        "Appreciation → Exclusive value → Community connection → Future opportunities",
  ...
  messagingFramework: {
    opening: {
      personal:
        "Hi [Name], I hope your [previous project/business/event] is bringing you joy!",
      educational:
        "I get asked this question all the time: [common customer question]",
      story:
        "Yesterday, I met with a [customer type] who told me the most amazing story...",
      seasonal:
        "As [season] approaches, I'm seeing more [customer type] interested in...",
    },

    value: {
      education: "Here's what most people don't know about [topic]...",
      inspiration:
        "Imagine walking into [space] and seeing [transformation]...",
    ...
    cta: {
      ...
      educational:
        "Want to learn more? I've put together a comprehensive guide...",
      social:
        "I'd love to hear about your [project/vision/space] - just reply and tell me!",
  ...
  designGuidelines: {
    ...
    colors:
      "Brand colors as accents, primarily clean white/gray with neon highlights",
    images:
      "High-quality project photos, behind-the-scenes shots, customer testimonials",
    mobile: "Mobile-first design with clear CTAs and readable fonts",
    accessibility:
      "Alt text for images, clear heading structure, sufficient color contrast",
  },
  ...
  personalization: {
    ...
    dynamic:
      "Recent project photos, relevant case studies, personalized recommendations",
  },
  ...
  complianceRequirements: {
    ...
    brandConsistency:
      "Maintain voice across all communications, template adherence",
  },
