export const agentKnowledgebase = {
  brandVoice:
    "Conversational and approachable - personal communication that builds relationships",
  ...
  communicationStyle: {
    ...
    language:
      "Clear, concise, and conversational - avoiding technical jargon unless necessary",
    emoji:
      "Strategic use of relevant emojis to enhance communication and add personality",
    response:
      "Quick, helpful responses that show genuine interest in customer needs",
  },
  ...
  products: [
    {
      ...
      messagingApproach: {
        inquiry:
          "Professional consultation via chat with quick photo sharing for context",
        follow:
          "Progress updates with photos, timeline confirmations, installation coordination",
        support:
          "Quick troubleshooting with visual guides, maintenance reminders",
      },
    },
    {
      ...
      messagingApproach: {
        inquiry:
          "Inspirational conversation about vision with mood board sharing",
        follow:
          "Design previews, setup coordination, last-minute change support",
    ...
    },
    {
      ...
      messagingApproach: {
        inquiry:
          "Personal design consultation with lifestyle-focused questions",
        follow:
          "Design options sharing, installation guidance, smart feature setup",
  ...
  messageTypes: {
    ...
    information:
      "Clear, helpful information sharing with visual aids when possible",
  ...
  conversationFlow: {
    initial:
      "Warm greeting → Understanding needs → Sharing expertise → Next steps",
    ongoing:
      "Progress updates → Visual sharing → Timeline confirmations → Support",
    support:
      "Issue acknowledgment → Diagnostic questions → Solution guidance → Follow-up",
  },

  visualCommunication: {
    photos:
      "High-quality project photos, behind-the-scenes shots, progress updates",
    videos:
      "Short instructional videos, time-lapse creation, installation guides",
