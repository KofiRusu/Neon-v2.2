export const agentKnowledgebase = {
    ...
    platforms: {
      googleAds: {
        ...
        brandVoiceAdaptation:
          "Direct and benefit-focused, answering specific search intent",
        keyStrengths:
          "High-intent keywords, local targeting, technical searches",
      },
      ...
      facebookAds: {
        ...
        keyStrengths:
          "Visual transformations, demographic targeting, lookalike audiences",
      },

      instagramAds: {
        campaigns: ["Stories", "Feed", "Reels", "Explore"],
        brandVoiceAdaptation:
          "Creative and inspirational with strong visual impact",
        keyStrengths:
          "Visual content, younger demographics, lifestyle targeting",
      },
      ...
      linkedinAds: {
        ...
        keyStrengths:
          "Business decision makers, professional services, B2B targeting",
      },
    },
  },
  ...
  products: [
    {
      ...
      adMessaging: {
        ...
        solution:
          "Custom neon that transforms your storefront into a customer magnet",
        proof:
          "48-hour rush, lifetime warranty, 70% energy savings, free consultation",
      },
    },
    {
      ...
      adMessaging: {
        ...
        solution:
          "Custom neon that transforms ordinary events into extraordinary experiences",
        proof:
          "Thousands of celebrations enhanced, quick turnaround, portable options",
      },
    },
    {
      category: "Home Décor",
      adMessaging: {
        ...
        proof:
          "Unlimited customization, energy-efficient, easy installation, app control",
      },
    },
  ],
  ...
  targetAudiences: {
    ...
    homeowners: {
      ...
      psychographics:
        "Style-conscious, home improvement focused, self-expression oriented",
      painPoints: [
        "Generic décor",
        "Lack of personality",
        "Mood lighting",
      ...
      messaging:
        "Express your unique personality and create spaces that truly reflect who you are",
    },

    restaurantOwners: {
      demographics: "Restaurant and bar owners, hospitality industry",
      psychographics:
        "Customer experience focused, ambiance conscious, competitive",
      painPoints: [
        "Atmosphere creation",
        "Visibility",
        "Customer retention",
      ...
      messaging:
        "Create an unforgettable dining atmosphere that keeps customers coming back",
    },
  },
  ...
  adFormats: {
    ...
    displayAds: {
      visuals:
        "Before/after transformations, glowing neon in context, happy customers",
    ...
    carouselAds: {
      ...
      images:
        "High-contrast project photos with clear transformation narrative",
    },
  },
  ...
  landingPageStrategy: {
    businessSigns: {
      headline:
        "Professional Custom Neon Signs That Attract 40% More Customers",
      subheadline:
        "Transform your storefront with energy-efficient LED neon. Free consultation + 48-hour rush available.",
      socialProof:
        "Customer testimonials, before/after photos, business results",
    ...
    homeDecor: {
      ...
      socialProof:
        "Home transformation photos, lifestyle imagery, customer stories",
  ...
  performanceMetrics: {
    ...
    conversion:
      "Cost per consultation, consultation to sale rate, return on ad spend",
    retention:
      "Customer lifetime value, repeat customer rate, referral attribution",
  },
};
