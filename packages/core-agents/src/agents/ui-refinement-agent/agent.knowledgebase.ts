export const agentKnowledgebase = {
  ...
  designSystem: {
    ...
    components: {
      ...
      navigation:
        "Clean layout with smooth transitions and clear active states",
    },
  },
  ...
  interactionDesign: {
    animations:
      "Purposeful, delightful, performance-conscious (200-300ms duration)",
    microinteractions:
      "Subtle button scaling, smooth form transitions, gentle hover effects",
  ...
  responsiveDesign: {
    ...
    considerations:
      "Touch-friendly navigation, readable typography, optimized images",
  },
  ...
  contentStrategy: {
    ...
    hierarchy:
      "Benefit-focused headlines, descriptive subheadings, concise body text",
