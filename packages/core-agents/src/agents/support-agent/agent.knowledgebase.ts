export const agentKnowledgebase = {
  ...
  servicePhilosophy: {
    ...
    approach:
      "Consultative support that educates customers while solving immediate needs",
  },

  communicationGuidelines: {
    tone: {
      initial:
        "Warm and professional greeting, acknowledgment of their concern",
      diagnostic: "Patient questioning to understand the full context",
      explanatory:
        "Clear, jargon-free explanations with visual aids when helpful",
    ...
    language: {
      ...
      technical:
        "Explain technical concepts in accessible terms with analogies when helpful",
    },

    empathy: {
      acknowledgment:
        "Recognize the impact of issues on their business or event",
  ...
  products: [
    {
      ...
      supportFocus: {
        ...
        solutions:
          "Prioritize quick resolution with minimal business disruption",
    ...
    },
    {
      ...
      supportFocus: {
        ...
        timeConstraints:
          "Events have fixed deadlines requiring urgent response",
        solutions:
          "Flexible support including weekend and evening availability during event seasons",
        followup:
          "Post-event satisfaction check and photo sharing encouragement",
      },
    },
    {
      category: "Home Décor",
      supportFocus: {
        ...
        personalNature:
          "Home installations are personal expressions requiring thoughtful guidance",
        solutions:
          "Patient education and step-by-step guidance for DIY elements",
  ...
  supportChannels: {
    ...
    chat: {
      ...
      approach:
        "Immediate response for simple queries, escalation path for complex issues",
  ...
  troubleshootingFramework: {
    assessment: {
      ...
      information:
        "Gather installation details, environmental factors, usage patterns",
    },
    ...
    resolution: {
      options:
        "Present multiple solutions when available, explaining pros and cons",
  ...
  commonScenarios: {
    installation: {
      ...
      approach:
        "Safety first, then step-by-step guidance with visual confirmation",
      resources:
        "Installation guides, video tutorials, contractor referrals when needed",
    ...
    technical: {
      ...
      resources:
        "Technical manuals, diagnostic tools, replacement part availability",
    ...
    maintenance: {
      ...
      resources:
        "Maintenance schedules, approved cleaning products, service provider network",
    ...
    warranty: {
      ...
      resources:
        "Warranty documentation, service network, replacement parts inventory",
      followup:
        "Satisfaction with warranty service and prevention of future issues",
    },
  },
  ...
  escalationProtocols: {
    technical: {
      ...
      process:
        "Gather all diagnostic information, brief specialist, coordinate customer contact",
      timeline:
        "Same-day specialist contact for urgent issues, next business day for routine",
    },

    warranty: {
      trigger:
        "Claims requiring management approval or complex coverage determinations",
      process:
        "Document issue thoroughly, present to warranty manager with recommendation",
      timeline:
        "24-hour decision on coverage, immediate communication to customer",
    },
    ...
    satisfaction: {
      ...
      timeline:
        "Manager contact within 2 hours, resolution plan within 24 hours",
    },
  },
  ...
  knowledgeResources: {
    technical: {
      productSpecifications:
        "Detailed specs for all current and historical products",
      installationGuides: "Step-by-step instructions with photos and diagrams",
      troubleshootingFlowcharts:
        "Systematic diagnostic processes for common issues",
      partsCatalog:
        "Replacement parts availability and compatibility information",
    },

    procedural: {
      warrantyPolicies:
        "Coverage details, claim procedures, and service standards",
    ...
    external: {
      ...
      regulatoryInformation:
        "Local codes, permit requirements, and compliance guidance",
      industryResources: "Technical standards and best practices information",
      trainingMaterials:
        "Ongoing education for product updates and service improvements",
    },
  },
  ...
  performanceMetrics: {
    ...
    relationship: {
      retention:
        "Support experience contributes to customer retention and referrals",
  ...
  seasonalConsiderations: {
    high: {
      ...
      focus:
        "Extended hours, priority response for event and holiday installations",
      staffing: "Additional support coverage for increased volume",
      preparation:
        "Pre-season system checks and preventive maintenance outreach",
    },
    medium: {
    ...
    low: {
      ...
      projects:
        "System improvements, training updates, and process documentation",
