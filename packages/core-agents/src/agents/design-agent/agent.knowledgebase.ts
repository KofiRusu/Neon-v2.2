export const agentKnowledgebase = {
  brandVoice:
    "Creative and inspirational - balancing artistic vision with practical application",
  ...
  products: [
    {
      ...
      designApproach: {
        ...
        aesthetics:
          "Clean, bold, readable - focused on maximum impact and brand consistency",
        considerations: [
          "Viewing distance",
          "Ambient lighting",
    ...
    },
    {
      ...
      designApproach: {
        ...
        aesthetics:
          "Artistic, celebratory, Instagram-worthy - designed for social sharing",
        considerations: [
          "Event duration",
          "Indoor/outdoor use",
          "Power accessibility",
    ...
    },
    {
      ...
      designApproach: {
        ...
        materials:
          "Energy-efficient LED with smart controls and dimming capabilities",
      },
    },
  ],
  ...
  designProcess: {
    discovery: {
      brandAnalysis:
        "Understand client brand identity, values, and visual preferences",
      spatialContext:
        "Analyze installation environment, lighting conditions, and viewing angles",
      technicalRequirements:
        "Assess power, mounting, weather protection, and regulatory needs",
      inspirationGathering:
        "Collect visual references and explore creative possibilities",
    },

    conceptualization: {
      ideation:
        "Generate multiple design directions balancing creativity with constraints",
      sketching:
        "Hand-drawn concepts to explore form, proportion, and visual impact",
      digitalRendering:
        "Detailed mockups showing realistic neon glow and environmental context",
      clientPresentation:
        "Clear communication of design rationale and expected outcomes",
    },
    ...
    refinement: {
      ...
      engineering:
        "Technical drawings ensuring manufacturability and installation success",
      prototyping:
        "Small-scale tests for complex or innovative design elements",
    ...
    execution: {
      ...
      testing:
        "Pre-installation testing of all electrical and mechanical components",
      installation: "Professional installation with attention to design intent",
      handoff:
        "Client education on operation, maintenance, and warranty coverage",
    },
  },
  ...
  designSpecialties: {
    typography: {
      ...
      innovation:
        "Creative letterform treatments that enhance message while maintaining clarity",
    },
    ...
    environmental: {
      expertise:
        "Architectural integration, spatial relationships, environmental harmony",
      considerations: [
        "Scale relationships",
        "Viewing angles",
        "Ambient lighting",
      ...
      innovation:
        "Designs that enhance rather than compete with existing architecture",
    },
    ...
    interactive: {
      ...
      innovation:
        "Smart neon integration with app control, scheduling, and dynamic effects",
    },
  },
  ...
  technicalConstraints: {
    manufacturing: {
      bendingRadius:
        "Minimum radius limitations for LED strip and traditional neon",
      sizeConstraints:
        "Maximum dimensions for shipping and installation considerations",
      mounting:
        "Structural requirements and attachment methods for different surfaces",
      weatherproofing:
        "IP ratings and protection requirements for outdoor installations",
    },
  ...
  materialSelection: {
    ledTechnology: {
      ...
      applications:
        "Suitable for most applications with cost and efficiency benefits",
      limitations: "Slightly different aesthetic from traditional neon",
      innovation:
        "Continuous improvements in color accuracy and neon-like appearance",
    },

    traditionalNeon: {
      advantages: "Authentic glow, color richness, established aesthetic",
      applications:
        "Premium applications where authentic neon look is essential",
      limitations:
        "Higher energy consumption, shorter lifespan, limited smart features",
  ...
  qualityStandards: {
    design:
      "Every design must meet functional requirements while exceeding aesthetic expectations",
    technical:
      "All specifications must be achievable within manufacturing capabilities and budget",
    brand:
      "Design solutions must reinforce brand identity and messaging objectives",
  ...
  clientCollaboration: {
    ...
    delivery:
      "Comprehensive documentation and support throughout project lifecycle",
  },
  ...
  designInnovation: {
    emerging:
      "Exploring new LED technologies, smart integration, and sustainable materials",
    research:
      "Continuous study of lighting trends, architectural integration, and user experience",
    experimentation:
      "Regular prototyping and testing of new techniques and materials",
    collaboration:
      "Partnership with technology vendors and industry innovators",
  },
};
