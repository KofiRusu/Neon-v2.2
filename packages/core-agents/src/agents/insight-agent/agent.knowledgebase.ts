export const agentKnowledgebase = {
  ...
  analyticsFramework: {
    businessIntelligence: {
      focus:
        "Revenue optimization, customer lifetime value, and growth opportunities",
      metrics: [
      ...
      insights:
        "Identify high-value customer segments and optimize pricing strategies",
    },
    ...
    marketingROI: {
      ...
      insights:
        "Optimize marketing budget allocation and improve campaign performance",
    },
  },
  ...
  products: [
    {
      ...
      analyticsApproach: {
        ...
        performance:
          "Track business outcome metrics for customers to demonstrate ROI",
        insights:
          "Identify which business types see the highest value and target similar prospects",
        optimization:
          "Correlate sign characteristics with business performance improvements",
      },
    },
    {
    ...
    },
    {
      ...
      analyticsApproach: {
        ...
        performance:
          "Track design trend adoption and customer lifestyle alignment",
        insights: "Predict emerging design trends and customer preferences",
        optimization:
          "Personalize recommendations based on lifestyle and usage patterns",
      },
    },
  ],
  ...
  dataSourcesAndMetrics: {
    ...
    marketingData: {
      ...
      insights:
        "Marketing channel effectiveness, customer acquisition costs, campaign performance",
    },
    ...
    operationalData: {
      ...
      insights:
        "Operational efficiency, capacity planning, resource optimization",
    },
    ...
    competitiveData: {
      ...
      insights:
        "Competitive positioning, pricing strategy, market opportunities",
    },
  },
  ...
  predictiveAnalytics: {
    ...
    customerSegmentation: {
      purpose:
        "Identify high-value customer segments and personalization opportunities",
      inputs: [
        "Purchase history",
        "Demographic data",
        "Behavioral patterns",
      ...
      applications:
        "Targeted marketing, pricing strategies, customer retention programs",
    },
    ...
    pricingOptimization: {
      ...
      testing:
        "A/B test pricing strategies and measure impact on conversion and revenue",
    },
  },
  ...
  businessIntelligence: {
    customerAnalytics: {
      acquisition:
        "Identify most effective channels for acquiring qualified customers",
      retention:
        "Analyze factors that drive customer loyalty and repeat business",
      value:
        "Calculate customer lifetime value and identify high-value segments",
      behavior: "Understand customer journey and optimize touchpoints",
    },

    productAnalytics: {
      performance:
        "Track product popularity, profitability, and customer satisfaction",
  ...
  performanceTracking: {
    businessKPIs: {
      revenue:
        "Monthly recurring revenue, annual growth rate, revenue per customer",
      customers: "Customer acquisition rate, retention rate, lifetime value",
      operations:
        "Order fulfillment time, quality metrics, customer satisfaction",
      marketing:
        "Cost per acquisition, return on marketing investment, lead conversion rates",
    },

    alerting: {
      performance: "Automated alerts for KPI deviations and trending issues",
      opportunities:
        "Notifications for growth opportunities and optimization potential",
      risks:
        "Early warning system for customer churn, quality issues, and market changes",
  ...
  dataVisualization: {
    principles:
      "Clear, actionable visualizations that tell a story and drive decisions",
    tools:
      "Professional dashboards with interactive capabilities and drill-down options",
    accessibility:
  ...
  actionableInsights: {
    ...
    prioritization:
      "Rank recommendations by impact, effort, and strategic alignment",
    implementation: "Provide specific steps for implementing recommendations",
    measurement:
      "Define success metrics and tracking methods for recommendations",
  },

  dataGovernance: {
    quality:
      "Ensure data accuracy, completeness, and consistency across all sources",
    privacy:
      "Comply with data protection regulations and customer privacy expectations",
    security:
      "Implement appropriate security measures for sensitive business data",
  ...
  seasonalAnalytics: {
    high: {
      ...
      focus:
        "Demand spike analysis, capacity optimization, revenue maximization",
    ...
    low: {
      ...
      focus:
        "Deep analysis, planning for peak seasons, and strategic initiatives",
  ...
  continuousImprovement: {
    methodology:
      "Regular review and refinement of analytics methods and insights",
