export const agentKnowledgebase = {
  ...
  products: [
    {
      ...
      keyMessaging:
        "Transform your business presence with signs that work as hard as you do",
    },
    {
      ...
      keyMessaging:
        "Create unforgettable experiences that guests will remember and share",
    },
    {
      category: "Home Décor",
      contentFocus:
        "Personal expression, lifestyle enhancement, mood lighting, creative spaces",
      keyMessaging:
        "Illuminate your personality and create spaces that truly reflect who you are",
    },
  ],
  ...
  contentTypes: {
    blog: {
      ...
      structure:
        "Hook, educational content, practical application, call-to-action",
    },
    ...
    social: {
      ...
      platforms: {
        instagram:
          "Visual storytelling, behind-the-scenes, transformation reveals",
        facebook:
          "Community building, local business features, educational content",
        tiktok:
          "Quick tips, trending sounds with neon content, time-lapse creation",
        linkedin:
          "B2B focused, industry insights, business transformation stories",
      },
    },
    ...
    email: {
      ...
      segments: {
        prospects:
          "Educational content to build trust and demonstrate expertise",
        customers:
          "Exclusive insights, maintenance tips, upgrade opportunities",
        partners:
          "Industry updates, collaboration opportunities, referral programs",
      },
    },
  ...
  editorialGuidelines: {
    ...
    openings:
      "Start with a relatable problem or inspiring transformation story",
    structure: "Problem → Solution → Process → Results → Next Steps",
    evidence:
      "Include specific metrics, timelines, and customer quotes when possible",
  ...
  seasonalContent: {
    high: {
      ...
      content:
        "Holiday decoration ideas, wedding season inspiration, grand opening spotlights",
      messaging:
        "Premium positioning, extended capabilities, seasonal applications",
    },
    medium: {
      months: ["March", "April", "July", "August", "September"],
      content:
        "Design trends, renovation inspiration, back-to-school business prep",
      messaging: "Educational focus, trend reporting, practical applications",
    },
    low: {
      months: ["February", "October"],
      content:
        "Maintenance guides, behind-the-scenes content, planning resources",
  ...
  qualityStandards: {
    ...
    authenticity:
      "Content should reflect genuine expertise and real customer experiences",
    ...
    brandAlignment:
      "All content must reinforce our creative, professional, energetic brand voice",
  },
};
