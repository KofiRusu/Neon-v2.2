...
describe("AgentRegistry", () => {
  ...
  describe("createAgentInstance", () => {
    ...
    it("should throw error for invalid agent types", () => {
      expect(() => createAgentInstance("unknown")).toThrow(
        "Agent type not found: unknown",
      );
    });
  });
  ...
  describe("Edge cases and error handling", () => {
    ...
    it("should handle null/undefined inputs gracefully", () => {
      expect(() =>
        isAgentTypeRegistered(null as unknown as string),
      ).not.toThrow();
      expect(() =>
        getAgentByType(undefined as unknown as string),
      ).not.toThrow();
      expect(() =>
        getAgentsByCategory(null as unknown as string),
      ).not.toThrow();
    });
