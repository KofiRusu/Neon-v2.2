...
export const strategyTemplates: Record<string, StrategyTemplate> = {
  "product-launch": {
    ...
    goal: {
      type: "product_launch",
      objective:
        "Launch new product with market awareness and initial sales momentum",
      kpis: [
    ...
    audience: {
      ...
      persona: {
        ...
        description:
          "Early adopter who values innovative solutions and shares recommendations",
        motivations: [
    ...
    stages: [
      {
        ...
        description:
          "Analyze market conditions, competitor landscape, and trending topics",
      ...
      },
      {
        ...
        description:
          "Ensure messaging aligns with brand voice and resonates with target audience",
      ...
      },
      {
        ...
        description:
          "Create compelling content across all channels with SEO optimization",
      ...
      },
      {
        ...
        description:
          "Launch coordinated campaigns across social, email, and paid channels",
      ...
      },
      {
        ...
        description:
          "Track metrics, optimize performance, and generate insights",
  ...
  "seasonal-promo": {
    ...
    goal: {
      type: "seasonal_promo",
      objective:
        "Maximize sales during seasonal peak with engaging promotional content",
      kpis: [
    ...
    audience: {
      ...
      persona: {
        ...
        description:
          "Price-conscious consumer looking for deals during seasonal periods",
    ...
    stages: [
      {
        ...
        description:
          "Identify seasonal trends, shopping patterns, and competitive landscape",
        agents: ["trend-agent"],
        estimatedDuration: 3,
      },
      {
        ...
        description:
          "Create urgent, compelling promotional content with strong CTAs",
  ...
  "b2b-outreach": {
    ...
    description:
      "Targeted outreach campaign for B2B lead generation with personalized messaging",
    category: "conversion",
    goal: {
      type: "b2b_outreach",
      objective:
    ...
    audience: {
      ...
      persona: {
        ...
        description:
          "C-level or senior manager focused on business outcomes and ROI",
        motivations: [
          "business growth",
          "competitive advantage",
    ...
    stages: [
      {
        ...
        description:
          "Identify and research high-value target accounts and decision makers",
      ...
      },
      {
        ...
        description:
          "Create thought leadership content and personalized messaging",
      ...
      },
      {
        ...
        description:
          "Build relationships and guide prospects through sales funnel",
  ...
  "retargeting-campaign": {
    ...
    audience: {
      ...
      persona: {
        ...
        description:
          "Previously engaged prospect who needs additional motivation to convert",
        motivations: [
          "value confirmation",
          "social proof",
          "limited-time offers",
    ...
    stages: [
      {
        ...
        description:
          "Analyze user behavior and segment audiences based on engagement level",
        agents: ["insight-agent"],
        estimatedDuration: 5,
      },
      {
      ...
      },
      {
        ...
        description:
          "Execute retargeting campaigns across ads, email, and social",
...
export function getTemplatesByCategory(
  ...
  return Object.values(strategyTemplates).filter(
