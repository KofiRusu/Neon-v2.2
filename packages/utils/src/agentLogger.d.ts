 ...
 */
export declare function logSuccess(agent: AgentName, action: string, metadata?: Record<string, unknown>, duration?: number): Promise<void>;
/**
 * Logs failed agent execution
 */
export declare function logError(agent: AgentName, action: string, error: string | Error, metadata?: Record<string, unknown>): Promise<void>;
/**
 ...
 */
export declare function withLogging<T>(agent: AgentName, action: string, fn: () => Promise<T>, metadata?: Record<string, unknown>): Promise<T>;
