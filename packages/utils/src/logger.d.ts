...
export declare const logAgentAction: (agentName: string, action: string, result: "success" | "error", context?: Record<string, unknown>) => void;
export declare const logPerformanceMetric: (metric: string, value: number, threshold?: number) => void;
