...
export class PDFGenerator {
  ...
  async generateOfferSheet(
    ...
    doc.setFontSize(12);
    doc.text(
      "Offer expires end of month • Limited availability",
      20,
      yPos + 18,
    );
  ...
  async generateCatalog(products: any[]): Promise<Buffer> {
    ...
    doc.setFont("helvetica", "normal");
    doc.text(
      "Discover our complete range of custom neon signs and lighting solutions.",
      20,
      yPos,
    );
    doc.text(
    ...
    doc.text(
      "neon signs tailored to your specific brand and vision.",
      20,
      yPos + 8,
    );
    yPos += 20;
