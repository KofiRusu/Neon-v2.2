...
async function logEvent(data) {
    try {
        ...
        logger_1.logger.error('Failed to log agent event to database', { error, eventData: data }, 'AgentLogger');
...
async function logPerformance(data) {
    try {
        ...
        logger_1.logger.error('Failed to log agent performance', { error, performanceData: data }, 'AgentLogger');
    }
}
/**
