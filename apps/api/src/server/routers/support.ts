  ...
  classifyMessage: publicProcedure
    ...
    .mutation(async ({ input }) => {
      try {
        ...
        const result = await agent.classifyMessageAPI(
          input as MessageClassificationInput,
        );
  ...
  generateReply: publicProcedure
    ...
    .mutation(async ({ input }) => {
      try {
        ...
        const agent = new CustomerSupportAgent();
        const result = await agent.generateReplyAPI(
          input as ReplyGenerationInput,
        );
  ...
  analyzeSentiment: publicProcedure
    ...
    .mutation(async ({ input }) => {
      try {
        ...
        const agent = new CustomerSupportAgent();
        const result = await agent.analyzeSentimentAPI(
          input as SentimentAnalysisInput,
        );
