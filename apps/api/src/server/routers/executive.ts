...
const InsightFiltersSchema = z.object({
  dateRange: z
    ...
    .optional(),
  priorities: z
    .array(z.enum(["LOW", "MEDIUM", "HIGH", "CRITICAL", "URGENT"]))
    .optional(),
    ...
    .query(async ({ input }) => {
      ...
      const mockInsights = [
        ...
        },
        {
          ...
          summary:
            "ContentAgent + BrandVoiceAgent collaboration achieves 92% success rate.",
      ...
      const mockReports = [
        {
          ...
          description:
            "Comprehensive weekly analysis covering campaign performance",
          reportType: "WEEKLY_DIGEST",
          status: "READY",
          priority: "HIGH",
          summary:
            "Analysis reveals 4 key insights with 4 actionable recommendations.",
          keyFindings: [
