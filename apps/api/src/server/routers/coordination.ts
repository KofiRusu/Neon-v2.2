...
export const coordinationRouter = router({
  ...
  submitGoal: publicProcedure
    ...
    .mutation(async ({ input }) => {
      try {
        console.log(
          `🎯 [CoordinationAPI] Goal submission:`,
          input.goalRequest.title,
        );
        ...
        const activities = [
          {
            ...
            goalPlanId: "goal_001",
            message:
              "Plan accepted by consensus with quorum 8/9 agents (score: 0.89)",
          },
          {
            id: "activity_002",
            ...
            goalPlanId: "goal_003",
            message:
              "Agent 'ContentAgent' proposed plan with 92% brand alignment",
          },
          {
            id: "activity_003",
            ...
            goalPlanId: "goal_002",
            message:
              "Phase 1 execution started: Market Research & Competitive Analysis",
          },
        ];
            ...
            subgoals: [
              {
                ...
                description:
                  "Analyze market conditions and competitor strategies",
                priority: 10,
                estimatedTime: 60,
