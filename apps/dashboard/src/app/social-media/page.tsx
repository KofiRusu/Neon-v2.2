  ...
  const socialAgents: SocialAgent[] = [
    {
      ...
      platform: "Instagram",
      status:
        generatePostMutation.isLoading && selectedPlatform === "instagram"
          ? "running"
          : "active",
      performance: 94,
      postsToday: 8,
    ...
    },
    {
      ...
      platform: "LinkedIn",
      status:
        generatePostMutation.isLoading && selectedPlatform === "linkedin"
          ? "running"
          : "active",
      performance: 91,
      postsToday: 3,
    ...
    },
    {
      ...
      platform: "Twitter",
      status:
        generatePostMutation.isLoading && selectedPlatform === "twitter"
          ? "running"
          : "active",
      performance: 89,
      postsToday: 12,
          ...
          {showGeneratedPost && generatedPost ? (
            ...
            <div className="glass-strong p-6 rounded-2xl text-center">
              ...
              <p className="text-secondary text-sm">
                Enter a topic and run the agent to generate AI-powered social
                media content
              </p>
            </div>
          )}
          ...
          <div key={metric.platform} className="stat-card">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <div className={`stat-number text-${metric.color}`}>
                  {metric.posts}
                </div>
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-3">
                    <div
                      className={`w-12 h-12 bg-${agent.color} rounded-xl flex items-center justify-center`}
                    >
                  ...
                  <div className="flex items-center space-x-2">
                    <div
                      className={`px-3 py-1 rounded-full text-xs font-semibold ${getStatusBg(agent.status)} ${getStatusColor(agent.status)}`}
                    >
                      {agent.status}
                    </div>
