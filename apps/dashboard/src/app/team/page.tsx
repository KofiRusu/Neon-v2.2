    ...
    <div className="min-h-screen p-6">
          ...
          <div className="stat-card">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <div className="stat-number text-neon-purple">{teamMembers.length}</div>
          ...
          <div className="stat-card">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <div className="stat-number text-yellow-400">{pendingInvites.length}</div>
      ...
      <div className="space-y-8">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-1">
                        ...
                        <div className={`flex items-center space-x-1 text-xs ${getStatusColor(member.status)}`}>
        ...
        {pendingInvites.length > 0 && (
          <div className="glass-strong p-6 rounded-2xl">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold text-primary">Pending Invitations</h2>
              <div className="text-sm text-secondary">
            ...
            <div className="space-y-4">
              {pendingInvites.map((invite) => (
                <div key={invite.id} className="glass p-4 rounded-xl border border-yellow-400/20">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      {/* Pending Icon */}
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-1">
                          <h3 className="font-semibold text-primary">{invite.email}</h3>
                        ...
                        <div className="flex items-center space-x-4 text-sm text-secondary">
                          ...
                          <div>Sent: {invite.invitedAt.toLocaleDateString()}</div>
                          <div>Expires: {invite.expiresAt.toLocaleDateString()}</div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="glass-strong p-6 rounded-2xl border border-neon-blue/30">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-primary mb-2">Beta Feature</h3>
              <p className="text-secondary leading-relaxed mb-4">
                Team management is currently in beta. Some features like role-based permissions, 
                advanced member analytics, and bulk actions are still being integrated. 
