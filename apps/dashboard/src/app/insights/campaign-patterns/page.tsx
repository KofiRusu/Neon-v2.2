    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 p-6">
        <div className="flex items-center justify-center h-64">
          ...
          <span className="ml-3 text-neon-blue font-medium">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-400 mt-2">
              Cross-campaign learning, pattern mining, and predictive campaign
              generation
            </p>
          </div>
        ...
        {systemStatus?.data && (
          <Alert className="border border-neon-blue/20 bg-slate-800/50 backdrop-blur-sm">
            ...
            <AlertDescription className="text-slate-300">
              ...
              <Badge
                variant="outline"
                className="text-green-400 border-green-400 ml-2"
              >
                {systemStatus.data.overall}
              </Badge>
              <span className="ml-4 text-sm">
                {systemStatus.data.components.patternMiner.patternsMinedToday}{" "}
                patterns mined today •
                {systemStatus.data.components.autoReplayEngine.activeReplays}{" "}
                active replays • Uptime: {systemStatus.data.uptime}
              </span>
            </AlertDescription>
          </Alert>
        )}
