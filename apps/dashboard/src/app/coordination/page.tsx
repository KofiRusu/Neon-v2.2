              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    <StatusIcon
                      className={`h-6 w-6 ${getStatusColor(workflow.status)}`}
                    />
                    <div>
              ...
              return (
                <div key={agent.id} className="glass p-4 rounded-xl">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <StatusIcon
                      className={`h-5 w-5 ${getStatusColor(agent.status)}`}
                    />
                  </div>
          ...
          <div className="space-y-4">
            <div className="glass p-4 rounded-xl">
              ...
              <p className="text-sm text-primary">
                ContentAgent completed blog post generation
              </p>
            </div>
            ...
            <div className="glass p-4 rounded-xl">
              ...
              <p className="text-sm text-primary">
                EmailAgent deploying personalized sequences
              </p>
            </div>
            ...
            <div className="glass p-4 rounded-xl">
              ...
              <p className="text-sm text-primary">
                SEOAgent queued for content optimization
              </p>
            </div>
            ...
            <div className="glass p-4 rounded-xl">
              ...
              <p className="text-sm text-primary">
                AdAgent: Budget threshold reached, switching to optimization
                mode
              </p>
            </div>
          </div>
