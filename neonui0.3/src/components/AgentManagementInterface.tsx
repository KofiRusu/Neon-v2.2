...
const mockAgents: Agent[] = [
  ...
  },
  {
    ...
    capabilities: ['Multi-platform Posting', 'Engagement Tracking', 'Hashtag Optimization'],
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-secondary">Monitor and control AI agents</p>
              </div>
            </div>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      <div className={`w-12 h-12 bg-${agent.status === 'active' ? 'neon-blue' : agent.status === 'error' ? 'neon-pink' : 'neon-purple'} rounded-xl flex items-center justify-center`}>
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="relative w-16 h-16">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <span className="text-sm font-bold text-neon-blue">{agent.performance}%</span>
                        </div>
                      </div>
                      
                      <div className="space-y-1">
                        <div className="text-xs text-secondary">Uptime</div>
                        <div className="text-sm font-semibold text-primary">{agent.uptime}</div>
                        <div className="text-xs text-muted">{agent.lastAction}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <div className="flex justify-between text-xs mb-1">
                        ...
                        <span className="text-neon-green">{agent.cpuUsage}%</span>
                      </div>
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <input
                    ...
                    onChange={(e) => setCommandExecution(prev => ({ ...prev, command: e.target.value }))}
                  />
                ...
                <div className="grid grid-cols-3 gap-3">
                  <input
                    ...
                    onChange={(e) => setCommandExecution(prev => ({ 
                      ...prev, 
                      parameters: { ...prev.parameters, audience: e.target.value }
                    }))}
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e) => setCommandExecution(prev => ({ 
                      ...prev, 
                      parameters: { ...prev.parameters, tone: e.target.value }
                    }))}
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e) => setCommandExecution(prev => ({ 
                      ...prev, 
                      parameters: { ...prev.parameters, topic: e.target.value }
                    }))}
                  />
                </div>
                
                <button
                  onClick={() => executeCommand(commandExecution.command, commandExecution.parameters)}
                  disabled={!selectedAgent || !commandExecution.command || commandExecution.status === 'running'}
                  ...
                  {logs.map((log, index) => (
                    <motion.div
                      ...
                      className={`p-2 rounded border-l-4 ${
                        log.level === 'success' ? 'border-neon-green bg-green-900/20 text-green-300' :
                        log.level === 'error' ? 'border-neon-pink bg-red-900/20 text-red-300' :
                        log.level === 'warning' ? 'border-neon-orange bg-yellow-900/20 text-yellow-300' :
                    ...
                    >
                      <div className="flex items-center space-x-2 mb-1">
                        ...
                        <span className={`text-xs px-2 py-1 rounded ${
                          log.level === 'success' ? 'bg-neon-green text-black' :
                          log.level === 'error' ? 'bg-neon-pink text-white' :
                          log.level === 'warning' ? 'bg-neon-orange text-black' :
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-800">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-primary">Expanded Terminal</h3>
                    <p className="text-secondary">Full-screen agent monitoring and control</p>
                  </div>
                </div>
                  ...
                  {logs.map((log) => (
                    <div
                      ...
                      className={`p-4 rounded-lg border-l-4 ${
                        log.level === 'success' ? 'border-neon-green bg-green-900/30 text-green-300' :
                        log.level === 'error' ? 'border-neon-pink bg-red-900/30 text-red-300' :
                        log.level === 'warning' ? 'border-neon-orange bg-yellow-900/30 text-yellow-300' :
                    ...
                    >
                      ...
                      <div className="text-base leading-relaxed">{log.message}</div>
                    </div>
                  ))}
                </div>
              </div>
