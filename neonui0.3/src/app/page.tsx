...
import { ArrowRight, Bot, BarChart3, Zap, Users, Globe, CheckCircle2, Star, TrendingUp } from "lucide-react";
import Link from "next/link";

export default function HomePage() {
  // Health check to show system status
  const { data: healthData, isLoading: healthLoading } = api.health.ping.useQuery();
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link href="/analytics">
                <Button variant="outline" size="lg" className="border-purple-500 text-purple-300 hover:bg-purple-500/10 px-8 py-4 text-lg">
                  View Analytics
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center space-x-6">
            <div className="flex items-center space-x-2">
              <div className={`w-3 h-3 rounded-full ${healthData ? 'bg-green-500' : 'bg-yellow-500'} ${healthData ? '' : 'animate-pulse'}`}></div>
              <span className="text-gray-300">
                System Status: {healthLoading ? 'Checking...' : healthData ? 'Operational' : 'Loading'}
              </span>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Everything you need to create, manage, and optimize marketing campaigns at scale
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-slate-800/50 border-purple-500/30 hover:border-purple-500/60 transition-colors">
              <CardHeader>
                ...
                <CardDescription className="text-gray-300">
                  Deploy specialized AI agents for content generation, SEO optimization, and campaign management
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Link href="/agents">
            ...
            <Card className="bg-slate-800/50 border-purple-500/30 hover:border-purple-500/60 transition-colors">
              <CardHeader>
                ...
                <CardDescription className="text-gray-300">
                  Advanced analytics dashboard with performance tracking and ROI optimization
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Link href="/analytics">
            ...
            <Card className="bg-slate-800/50 border-purple-500/30 hover:border-purple-500/60 transition-colors">
              <CardHeader>
                ...
                <CardDescription className="text-gray-300">
                  Automated campaign creation, A/B testing, and performance optimization
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Link href="/campaigns">
            ...
            <Card className="bg-slate-800/50 border-purple-500/30 hover:border-purple-500/60 transition-colors">
              <CardHeader>
                ...
                <CardDescription className="text-gray-300">
                  Deep customer analytics and behavior tracking for better targeting
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Link href="/customers">
            ...
            <Card className="bg-slate-800/50 border-purple-500/30 hover:border-purple-500/60 transition-colors">
              <CardHeader>
                ...
                <CardDescription className="text-gray-300">
                  Manage campaigns across social media, email, and digital advertising platforms
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-slate-800/50 border-purple-500/30 hover:border-purple-500/60 transition-colors">
              <CardHeader>
                ...
                <CardDescription className="text-gray-300">
                  Intelligent marketing assistant for strategy, content, and optimization guidance
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Link href="/copilot">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-800/30">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl md:text-4xl font-bold text-purple-400 mb-2">34+</div>
              <div className="text-gray-300">Active Pages</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-bold text-green-400 mb-2">101KB</div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join the AI marketing revolution and scale your campaigns with intelligent automation
          </p>
