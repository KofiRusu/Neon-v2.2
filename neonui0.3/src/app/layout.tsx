...
import { QAToolsWidget } from "../components/qa-tools-widget";
...
export const metadata: Metadata = {
  ...
  description:
    "Transform your marketing with AI-powered automation, real-time analytics, and intelligent campaign management. Deploy specialized AI agents, track performance, and scale your campaigns effortlessly.",
  keywords: [
    "ai marketing",
  ...
  openGraph: {
    ...
    title: "NeonHub - AI Marketing Platform | Automate Your Marketing Success",
    description:
      "Transform your marketing with AI-powered automation, real-time analytics, and intelligent campaign management. Deploy specialized AI agents and scale your campaigns effortlessly.",
    siteName: "NeonHub",
    images: [
      {
        url: "/og-image.png",
