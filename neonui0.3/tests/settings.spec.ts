...
test.describe('Settings Page', () => {
  ...
  test('should display settings tabs', async ({ page }) => {
    ...
    const tabs = page.getByRole('tab', { name: /API|Database|Agent|Notification/i });
  ...
  test('should handle API key visibility toggle', async ({ page }) => {
    ...
    const eyeButton = page.getByRole('button').filter({ hasText: /👁|eye|show|hide/i })
  ...
  test('should display form validation', async ({ page }) => {
    ...
    const apiKeyInput = page.getByPlaceholder(/sk-/i).or(page.getByLabel(/API Key/i));
    ...
    if (await apiKeyInput.isVisible()) {
      ...
      const validationMessage = page.locator('text=Invalid')
  ...
  test('should display database configuration', async ({ page }) => {
    ...
    if (await databaseTab.isVisible()) {
      ...
      const dbInput = page.getByPlaceholder(/postgresql/i)
  ...
  test('should display agent settings', async ({ page }) => {
    ...
    if (await agentsTab.isVisible()) {
      ...
      const agentSettings = page.locator('text=timeout')
  ...
  test('should show debug mode toggle', async ({ page }) => {
    ...
    const debugToggle = page.getByLabel(/Debug Mode/i)
      .or(page.locator('text=Debug Mode').locator('..').locator('[role="switch"]'));
