...
test.describe('Campaigns Page', () => {
  ...
  test('should display campaign list or grid', async ({ page }) => {
    ...
    const campaignItems = page.locator('[data-testid="campaign-item"]')
      .or(page.locator('div').filter({ hasText: /campaign|Q1|Brand|Email|Social/ }))
  ...
  test('should have create campaign button', async ({ page }) => {
    ...
    const createButton = page.getByRole('button', { name: /create|new campaign|add campaign/i });
  ...
  test('should handle campaign actions', async ({ page }) => {
    ...
    const actionButtons = page.getByRole('button', { name: /edit|view|play|pause|stop/i });
  ...
  test('should display campaign metrics', async ({ page }) => {
    ...
    const metrics = page.locator('text=$')
  ...
  test('should be responsive on mobile', async ({ page }) => {
    ...
    const campaignItems = page.locator('div').filter({ hasText: /campaign|Q1|Brand|Email|Social/ });
