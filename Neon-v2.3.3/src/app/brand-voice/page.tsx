...
const recentAnalysis = [
  {
    id: 1,
    content:
      "Our new AI-powered marketing platform delivers unprecedented ROI...",
    platform: "LinkedIn",
    score: 94,
    issues: [],
    suggestions: [
  ...
  },
  {
    id: 2,
    content:
      "🚀 Excited to announce our latest product update! New features include...",
    platform: "Twitter",
    score: 87,
    issues: ["Tone slightly too casual for brand guidelines"],
    suggestions: [
      "Replace emoji with more professional language",
  ...
  },
  {
    id: 3,
    content:
      "How to maximize your marketing ROI with AI: A comprehensive guide",
    platform: "Blog",
    score: 96,
    issues: [],
        ...
        <div className="p-6">
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          ...
                          <span
                            className={`text-sm font-medium ${getStatusColor(attribute.status)}`}
                          >
                        ...
                        <div className="text-right">
                          <div
                            className={`text-lg font-bold ${getScoreColor(attribute.score)}`}
                          >
                            {attribute.score}%
                          </div>
                      ...
                      <div className="relative">
                        ...
                        <div
                          className="absolute top-0 w-1 h-2 bg-white/50"
                          style={{ left: `${attribute.target}%` }}
                        />
                      </div>
                    </motion.div>
                  ))}
                    ...
                    <button className="w-full text-left p-3 neon-glass rounded-lg hover:bg-white/5 transition-colors">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-400">
                            Upload content for voice analysis
                          </div>
                        </div>
                      </div>
                    </button>
          ...
          {selectedTab === "training" && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400">
                Advanced model training interface coming soon
              </p>
            </div>
          )}
          ...
          {selectedTab === "guidelines" && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400">
                Interactive guidelines editor coming soon
              </p>
            </div>
          )}
          ...
          {selectedTab === "reports" && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">
                Voice Analytics Reports
              </h3>
              <p className="text-gray-400">
                Detailed reporting dashboard coming soon
              </p>
            </div>
          )}
        </div>
